...
class platform1 : public rclcpp::Node{
  public:
  	platform1() : Node("station1"){
  		platform1_= this->create_publisher<std_msgs::msg::String>("/station1/platform1/trains",10);
  		platform2_= this->create_publisher<std_msgs::msg::String>("/station1/platform2/trains",10);
  ...
  private:
	...
	std::uniform_int_distribution<> destination_distrib(1, 3);
  	Train train={id_distrib(gen),1,destination_distrib(gen)};

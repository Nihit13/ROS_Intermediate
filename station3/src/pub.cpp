...
class platform1 : public rclcpp::Node{
  public:
  	platform1() : Node("station3"){
  		platform1_= this->create_publisher<std_msgs::msg::String>("/station3/platform1/trains",10);
  		platform2_= this->create_publisher<std_msgs::msg::String>("/station3/platform2/trains",10);
  ...
  private:
	...
	std::uniform_int_distribution<> destination_distrib(1, 2);
  	Train train={id_distrib(gen),3,destination_distrib(gen)};
